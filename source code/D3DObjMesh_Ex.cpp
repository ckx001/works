...
//
VOID AddObjFace_Ex(ObjTriangleList& objTriangleList, const TObjMesh& objMesh,
...
HRESULT CD3DMesh_Ex::Create(LPDIRECT3DDEVICE9 pD3DDevice, const TObjMesh& objMesh)
{
	...
	return InitVB(pD3DDevice, objMesh);
}
...
HRESULT CD3DMesh_Ex::InitVB(LPDIRECT3DDEVICE9 pD3DDevice, const TObjMesh& objMesh)
{
	HRESULT hr;
	SAFE_RELEASE(pVB);
	...
	for (UINT i = 0; i < objMesh.faces.size(); i++)
		AddObjFace_Ex(triList, objMesh, i, FALSE, FALSE);
